  ...
  return (
    <Card className="border-border/80 shadow-sm transition-shadow hover:shadow-md">
      <CardHeader className="pb-2">
        ...
        <CardDescription className="text-xs text-muted-foreground">{dateLabel}</CardDescription>
      </CardHeader>
      <CardContent className="space-y-3 text-sm">
        ...
        <div className="rounded-md border border-border/60 bg-muted/20 p-3 leading-relaxed text-foreground/95 whitespace-pre-wrap">
          {summary.summary}
        </div>
